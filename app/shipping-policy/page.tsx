...
export const metadata: Metadata = {
  title: 'Shipping Policy - Essentials Official | Essentials Jacket',
  description: 'Essentials Official shipping policy. Learn about shipping options, processing times, international shipping, and tracking information.',
  keywords: 'Essentials shipping, shipping policy, delivery information',
  openGraph: {
    title: 'Shipping Policy - Essentials Official',
    description: 'Essentials Official shipping policy and delivery information.',
    url: 'https://essentialsjacket.com/shipping-policy',
    siteName: 'Essentials Official',
    type: 'website',
  },
  alternates: {
    canonical: 'https://essentialsjacket.com/shipping-policy',
  },
}
